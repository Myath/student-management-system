...
! function (t) {
    t.fn.jRate = function (o) {
        ...
        function c(t, o) {
            t.on("mousemove", u(o)).on("mouseenter", u(o)).on("click", m(o)).on("mouseover", u(o)).on("hover", u(o)).on("mouseleave", d).on("mouseout", d).on("JRate.change", y).on("../../../../../webstrot.com/html/webstrotadmin/bootstrap3/default/JRate.html", k), M.touch && t.on("touchstart", w(o)).on("touchmove", w(o)).on("touchend", v(o)).on("tap", v(o))
        }
        ...
        function m(t) {
            return function (o) {
                g(o, t, "../../../../../webstrot.com/html/webstrotadmin/bootstrap3/default/JRate.html", !0)
            }
        }
